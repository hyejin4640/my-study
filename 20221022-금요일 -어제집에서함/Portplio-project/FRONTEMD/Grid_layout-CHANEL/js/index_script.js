(() => {
  ...
  const handlerModalClose =()=>{
    tagModal.classList.add('close');
    document.querySelector('.wrap').classList.remove('dark');
  }

  // 시작하자마자 모달창이보이면 body에 배경색을 흐리게
document.querySelector('.wrap').classList.add('dark');
  // ***************** 이벤트 등록 ************************************
...
btnClose.addEventListener('click',handlerModalClose );
})();
